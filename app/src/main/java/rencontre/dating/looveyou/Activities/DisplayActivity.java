...
import rencontre.dating.looveyou.Fragments.PeopleNearbyFragment;
import rencontre.dating.looveyou.Models.NotifyFilterChange;
import rencontre.dating.looveyou.Models.NotifyProfileRecieved;
                    ...
                    public void onCompleted(Exception e, JsonObject result) {
                        ...
                        try {
                            ...
                            if (jsonObject.optString(Const.Params.STATUS).equals("success")) {
                                ...
                                Glide.with(DisplayActivity.this).load(ApplicationSingleTon.imageUrl)
                                        .placeholder(R.drawable.profile_placeholder).dontAnimate().into(user_image);
